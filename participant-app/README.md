...
1. [Palworld Join v1.0.2 Release](https://github.com/Woollest/palworld-unlim-server/releases/tag/participant-v1.0.2)から`Palworld-Join-Setup-1.0.2.exe`をダウンロードします。
2. セットアップを実行します。
