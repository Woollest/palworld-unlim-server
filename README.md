...
| **Palworld Join v1.0.0** | ゲーム参加者 | [参加者向けRelease](https://github.com/Woollest/palworld-unlim-server/releases/tag/participant-v1.0.0)の`Palworld-Join-Setup-1.0.0.exe` |
...
1. [Palworld Join v1.0.0 Release](https://github.com/Woollest/palworld-unlim-server/releases/tag/participant-v1.0.0)から`Palworld-Join-Setup-1.0.0.exe`をダウンロードする
